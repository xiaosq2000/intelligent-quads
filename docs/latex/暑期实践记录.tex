...
% \begin{marginfigure}
%     \centering
%     \includegraphics{QGroundControl.png}
%     \caption{QGroundControl}
% \end{marginfigure}
% \begin{marginfigure}
%     \centering
%     \includegraphics{无人机模型.jpg}
%     \caption{四旋翼无人机Gazebo模型}
% \end{marginfigure}
\section{成果}
通过MAVROS配置参数，屏蔽了底层FCU的飞控算法，直接用无线电控制四旋翼无人机的每个电机的PWM占空比，为进一步的强化学习算法实践铺垫。\marginnote[-0.5cm]{7月11日至7月14日完成}
\printindex
\end{document}
